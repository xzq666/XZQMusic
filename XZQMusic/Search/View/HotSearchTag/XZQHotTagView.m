...
// 是否高度固定
@property(nonatomic,assign) BOOL isIntrinsicHeight;

@end

@implementation XZQHotTagView
...
- (void)insertTag:(XZQHotTag *)tag atIndex:(NSUInteger)index {
    NSParameterAssert(tag);
